...
scatter.int <- ggplot(data=ci.data, aes(x = plot.int)) +
 ...
 geom_line( aes(x = plot.int, y = fitted), lty = 2) +
  ...
  ylim(0, 1) +
  geom_hline(yintercept = 0.50, color = "red", linetype = "dashed") +scale_colour_manual(values = c("Dark Grey", "Black", "Red"))+ scale_x_continuous(breaks = seq(from = 36, to = 72, by = 4))+theme(legend.position = "none")
scatter.int

ggsave("shakenboxes.png",width = 4, height = 5, scale=0.5)
...
graph
ggsave("shaken causal.png",width = 5, height = 5, scale=0.7)
